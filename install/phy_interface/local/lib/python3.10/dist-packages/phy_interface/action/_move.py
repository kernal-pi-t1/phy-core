...
class Metaclass_Move_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('phy_interface')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_Goal')
            logger.debug(
...
class Metaclass_Move_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Move_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_SendGoal_Request(metaclass=Metaclass_Move_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'phy_interface/Move_Goal',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['phy_interface', 'action'], 'Move_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from phy_interface.action._move import Move_Goal
...
class Metaclass_Move_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from phy_interface.action import _move
...
class Move_SendGoal(metaclass=Metaclass_Move_SendGoal):
    from phy_interface.action._move import Move_SendGoal_Request as Request
    from phy_interface.action._move import Move_SendGoal_Response as Response
...
class Move_GetResult_Response(metaclass=Metaclass_Move_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'phy_interface/Move_Result',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['phy_interface', 'action'], 'Move_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from phy_interface.action._move import Move_Result
...
class Metaclass_Move_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_GetResult(metaclass=Metaclass_Move_GetResult):
    from phy_interface.action._move import Move_GetResult_Request as Request
    from phy_interface.action._move import Move_GetResult_Response as Response
...
class Metaclass_Move_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'phy_interface.action.Move_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Move_FeedbackMessage(metaclass=Metaclass_Move_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'phy_interface/Move_Feedback',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['phy_interface', 'action'], 'Move_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from phy_interface.action._move import Move_Feedback
...
class Move(metaclass=Metaclass_Move):
    ...
    from phy_interface.action._move import Move_Goal as Goal
    # The result message defined in the action definition.
    from phy_interface.action._move import Move_Result as Result
    # The feedback message defined in the action definition.
    from phy_interface.action._move import Move_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from phy_interface.action._move import Move_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from phy_interface.action._move import Move_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from phy_interface.action._move import Move_FeedbackMessage as FeedbackMessage
