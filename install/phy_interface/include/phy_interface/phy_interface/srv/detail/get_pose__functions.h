...
#ifndef PHY_INTERFACE__SRV__DETAIL__GET_POSE__FUNCTIONS_H_
#define PHY_INTERFACE__SRV__DETAIL__GET_POSE__FUNCTIONS_H_
 ...
 * calls
 * phy_interface__srv__GetPose_Request__init().
...
/**
 * It calls
 * phy_interface__srv__GetPose_Request__fini()
 ...
 * phy_interface__srv__GetPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * phy_interface__srv__GetPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * phy_interface__srv__GetPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It calls
 * phy_interface__srv__GetPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It allocates the memory for the array and calls
 * phy_interface__srv__GetPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It calls
 * phy_interface__srv__GetPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PHY_INTERFACE__SRV__DETAIL__GET_POSE__FUNCTIONS_H_
