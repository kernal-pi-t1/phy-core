...
pick_place_interfaces__srv__GetPickPose_Request__init(pick_place_interfaces__srv__GetPickPose_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->object_name)) {
    pick_place_interfaces__srv__GetPickPose_Request__fini(msg);
    return false;
  }
  return true;
}
...
pick_place_interfaces__srv__GetPickPose_Request__create()
{
  ...
  pick_place_interfaces__srv__GetPickPose_Request * msg = (pick_place_interfaces__srv__GetPickPose_Request *)allocator.allocate(sizeof(pick_place_interfaces__srv__GetPickPose_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pick_place_interfaces__srv__GetPickPose_Request));
  bool success = pick_place_interfaces__srv__GetPickPose_Request__init(msg);
  if (!success) {
...
pick_place_interfaces__srv__GetPickPose_Request__Sequence__init(pick_place_interfaces__srv__GetPickPose_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pick_place_interfaces__srv__GetPickPose_Request * data = NULL;

  if (size) {
    data = (pick_place_interfaces__srv__GetPickPose_Request *)allocator.zero_allocate(size, sizeof(pick_place_interfaces__srv__GetPickPose_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pick_place_interfaces__srv__GetPickPose_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        pick_place_interfaces__srv__GetPickPose_Request__fini(&data[i - 1]);
      }
...
pick_place_interfaces__srv__GetPickPose_Request__Sequence__fini(pick_place_interfaces__srv__GetPickPose_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      pick_place_interfaces__srv__GetPickPose_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pick_place_interfaces__srv__GetPickPose_Request__Sequence * array = (pick_place_interfaces__srv__GetPickPose_Request__Sequence *)allocator.allocate(sizeof(pick_place_interfaces__srv__GetPickPose_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pick_place_interfaces__srv__GetPickPose_Request__Sequence__init(array, size);
  if (!success) {
...
pick_place_interfaces__srv__GetPickPose_Request__Sequence__destroy(pick_place_interfaces__srv__GetPickPose_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pick_place_interfaces__srv__GetPickPose_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pick_place_interfaces__srv__GetPickPose_Request__Sequence__are_equal(const pick_place_interfaces__srv__GetPickPose_Request__Sequence * lhs, const pick_place_interfaces__srv__GetPickPose_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pick_place_interfaces__srv__GetPickPose_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pick_place_interfaces__srv__GetPickPose_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pick_place_interfaces__srv__GetPickPose_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pick_place_interfaces__srv__GetPickPose_Request * data =
      (pick_place_interfaces__srv__GetPickPose_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pick_place_interfaces__srv__GetPickPose_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pick_place_interfaces__srv__GetPickPose_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!pick_place_interfaces__srv__GetPickPose_Request__copy(
...
pick_place_interfaces__srv__GetPickPose_Response__init(pick_place_interfaces__srv__GetPickPose_Response * msg)
{
  ...
  // success
  // pose
  if (!pick_place_interfaces__msg__ObjectPose__init(&msg->pose)) {
    pick_place_interfaces__srv__GetPickPose_Response__fini(msg);
    return false;
  }
  // error_message
...
pick_place_interfaces__srv__GetPickPose_Response__fini(pick_place_interfaces__srv__GetPickPose_Response * msg)
{
  ...
  // success
  // pose
  pick_place_interfaces__msg__ObjectPose__fini(&msg->pose);
  // error_message
...
pick_place_interfaces__srv__GetPickPose_Response__are_equal(const pick_place_interfaces__srv__GetPickPose_Response * lhs, const pick_place_interfaces__srv__GetPickPose_Response * rhs)
{
  ...
  // pose
  if (!pick_place_interfaces__msg__ObjectPose__are_equal(
      &(lhs->pose), &(rhs->pose)))
  {
    return false;
  }
  ...
  pick_place_interfaces__srv__GetPickPose_Response * output)
{
  ...
  // pose
  if (!pick_place_interfaces__msg__ObjectPose__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pick_place_interfaces__srv__GetPickPose_Response * msg = (pick_place_interfaces__srv__GetPickPose_Response *)allocator.allocate(sizeof(pick_place_interfaces__srv__GetPickPose_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(pick_place_interfaces__srv__GetPickPose_Response));
  bool success = pick_place_interfaces__srv__GetPickPose_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
pick_place_interfaces__srv__GetPickPose_Response__Sequence__init(pick_place_interfaces__srv__GetPickPose_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pick_place_interfaces__srv__GetPickPose_Response * data = NULL;

  if (size) {
    data = (pick_place_interfaces__srv__GetPickPose_Response *)allocator.zero_allocate(size, sizeof(pick_place_interfaces__srv__GetPickPose_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = pick_place_interfaces__srv__GetPickPose_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        pick_place_interfaces__srv__GetPickPose_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
pick_place_interfaces__srv__GetPickPose_Response__Sequence__fini(pick_place_interfaces__srv__GetPickPose_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      pick_place_interfaces__srv__GetPickPose_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  pick_place_interfaces__srv__GetPickPose_Response__Sequence * array = (pick_place_interfaces__srv__GetPickPose_Response__Sequence *)allocator.allocate(sizeof(pick_place_interfaces__srv__GetPickPose_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = pick_place_interfaces__srv__GetPickPose_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
pick_place_interfaces__srv__GetPickPose_Response__Sequence__destroy(pick_place_interfaces__srv__GetPickPose_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    pick_place_interfaces__srv__GetPickPose_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
pick_place_interfaces__srv__GetPickPose_Response__Sequence__are_equal(const pick_place_interfaces__srv__GetPickPose_Response__Sequence * lhs, const pick_place_interfaces__srv__GetPickPose_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!pick_place_interfaces__srv__GetPickPose_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  pick_place_interfaces__srv__GetPickPose_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(pick_place_interfaces__srv__GetPickPose_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    pick_place_interfaces__srv__GetPickPose_Response * data =
      (pick_place_interfaces__srv__GetPickPose_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!pick_place_interfaces__srv__GetPickPose_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          pick_place_interfaces__srv__GetPickPose_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!pick_place_interfaces__srv__GetPickPose_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
