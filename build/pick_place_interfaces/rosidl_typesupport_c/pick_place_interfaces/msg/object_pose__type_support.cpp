...
static const _ObjectPose_type_support_symbol_names_t _ObjectPose_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pick_place_interfaces, msg, ObjectPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pick_place_interfaces, msg, ObjectPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pick_place_interfaces, msg, ObjectPose)() {
  return &::pick_place_interfaces::msg::rosidl_typesupport_c::ObjectPose_message_type_support_handle;
}
