...
static const _GetPickPose_Request_type_support_symbol_names_t _GetPickPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pick_place_interfaces, srv, GetPickPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pick_place_interfaces, srv, GetPickPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pick_place_interfaces, srv, GetPickPose_Request)() {
  return &::pick_place_interfaces::srv::rosidl_typesupport_c::GetPickPose_Request_message_type_support_handle;
}
...
static const _GetPickPose_Response_type_support_symbol_names_t _GetPickPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pick_place_interfaces, srv, GetPickPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pick_place_interfaces, srv, GetPickPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pick_place_interfaces, srv, GetPickPose_Response)() {
  return &::pick_place_interfaces::srv::rosidl_typesupport_c::GetPickPose_Response_message_type_support_handle;
}
...
static const _GetPickPose_type_support_symbol_names_t _GetPickPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pick_place_interfaces, srv, GetPickPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pick_place_interfaces, srv, GetPickPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, pick_place_interfaces, srv, GetPickPose)() {
  return &::pick_place_interfaces::srv::rosidl_typesupport_c::GetPickPose_service_type_support_handle;
}
