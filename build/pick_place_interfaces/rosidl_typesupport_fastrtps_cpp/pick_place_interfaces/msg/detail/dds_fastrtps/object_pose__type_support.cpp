...
#include "pick_place_interfaces/msg/detail/object_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pick_place_interfaces::msg::ObjectPose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pick_place_interfaces::msg::ObjectPose & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pick_place_interfaces::msg::ObjectPose;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pick_place_interfaces::msg::ObjectPose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pick_place_interfaces::msg::ObjectPose *>(
    untyped_ros_message);
...
{
  return &pick_place_interfaces::msg::typesupport_fastrtps_cpp::_ObjectPose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pick_place_interfaces, msg, ObjectPose)() {
  return &pick_place_interfaces::msg::typesupport_fastrtps_cpp::_ObjectPose__handle;
}
