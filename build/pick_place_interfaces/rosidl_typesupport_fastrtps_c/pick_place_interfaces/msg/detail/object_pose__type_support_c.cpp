...
#include "pick_place_interfaces/msg/detail/object_pose__rosidl_typesupport_fastrtps_c.h"
...
using _ObjectPose__ros_msg_type = pick_place_interfaces__msg__ObjectPose;
...
static uint32_t _ObjectPose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_pick_place_interfaces__msg__ObjectPose(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pick_place_interfaces__msg__ObjectPose;
    is_plain =
      (
...
static size_t _ObjectPose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_pick_place_interfaces__msg__ObjectPose(
