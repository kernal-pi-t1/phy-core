...
static const _GetPose_Request_type_support_symbol_names_t _GetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, phy_interface, srv, GetPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, phy_interface, srv, GetPose_Request)() {
  return &::phy_interface::srv::rosidl_typesupport_c::GetPose_Request_message_type_support_handle;
}
...
static const _GetPose_Response_type_support_symbol_names_t _GetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, phy_interface, srv, GetPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, phy_interface, srv, GetPose_Response)() {
  return &::phy_interface::srv::rosidl_typesupport_c::GetPose_Response_message_type_support_handle;
}
...
static const _GetPose_type_support_symbol_names_t _GetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, phy_interface, srv, GetPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, phy_interface, srv, GetPose)() {
  return &::phy_interface::srv::rosidl_typesupport_c::GetPose_service_type_support_handle;
}
