...
class GetPose_Response(metaclass=Metaclass_GetPose_Response):
    ...
    def __init__(self, **kwargs):
        ...
        if 'pose' not in kwargs:
            self.pose = numpy.zeros(6, dtype=numpy.float64)
        else:
    ...
    def pose(self, value):
        ...
        if __debug__:
            ...
            assert \
                ...
                "The 'pose' field must be a set or sequence with length 6 and each value of type 'float' and each double in [-.000000, .000000]"
...
class Metaclass_GetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from phy_interface.srv import _get_pose
...
class GetPose(metaclass=Metaclass_GetPose):
    from phy_interface.srv._get_pose import GetPose_Request as Request
    from phy_interface.srv._get_pose import GetPose_Response as Response
