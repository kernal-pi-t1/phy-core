...
#include "phy_interface/action/detail/move__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_Goal & ros_message)
{
  // Member: target_pose
  {
    cdr >> ros_message.target_pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phy_interface::action::Move_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_Goal *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_phy_interface
const rosidl_message_type_support_t *
get_message_type_support_handle<phy_interface::action::Move_Goal>()
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_Goal)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_Result & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_Result)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_Feedback & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_Feedback)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_Feedback__handle;
}
...
// functions for phy_interface::action::Move_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  phy_interface::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  phy_interface::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    phy_interface::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        phy_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_SendGoal_Request)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_SendGoal_Response)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal_Response__handle;
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_SendGoal)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_GetResult_Request)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for phy_interface::action::Move_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  cdr << ros_message.status;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        phy_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_GetResult_Response)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult_Response__handle;
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_GetResult)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_GetResult__handle;
}
...
// functions for phy_interface::action::Move_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::action::Move_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::action::Move_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        phy_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Move_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::action::Move_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::action::Move_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::action::Move_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, action, Move_FeedbackMessage)() {
  return &phy_interface::action::typesupport_fastrtps_cpp::_Move_FeedbackMessage__handle;
}
