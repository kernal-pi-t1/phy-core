...
#include "phy_interface/srv/detail/get_pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const phy_interface::srv::GetPose_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::srv::GetPose_Request & ros_message)
{
  // Member: method
  cdr >> ros_message.method;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phy_interface::srv::GetPose_Request;
    is_plain =
      (
      offsetof(DataType, method) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const phy_interface::srv::GetPose_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<phy_interface::srv::GetPose_Request *>(
    untyped_ros_message);
...
{
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, srv, GetPose_Request)() {
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_phy_interface
cdr_serialize(
  const phy_interface::srv::GetPose_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: pose
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  phy_interface::srv::GetPose_Response & ros_message)
{
  // Member: pose
  {
    cdr >> ros_message.pose;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface::srv::GetPose_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const phy_interface::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<phy_interface::srv::GetPose_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, srv, GetPose_Response)() {
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose_Response__handle;
}
...
{
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, phy_interface, srv, GetPose)() {
  return &phy_interface::srv::typesupport_fastrtps_cpp::_GetPose__handle;
}
