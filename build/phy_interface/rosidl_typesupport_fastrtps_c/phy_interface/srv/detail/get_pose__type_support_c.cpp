...
#include "phy_interface/srv/detail/get_pose__rosidl_typesupport_fastrtps_c.h"
...
using _GetPose_Request__ros_msg_type = phy_interface__srv__GetPose_Request;
...
size_t get_serialized_size_phy_interface__srv__GetPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_phy_interface__srv__GetPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_phy_interface
size_t max_serialized_size_phy_interface__srv__GetPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = phy_interface__srv__GetPose_Request;
    is_plain =
      (
...
static size_t _GetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_phy_interface__srv__GetPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose_Request)() {
...
using _GetPose_Response__ros_msg_type = phy_interface__srv__GetPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_phy_interface
size_t get_serialized_size_phy_interface__srv__GetPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetPose_Response__ros_msg_type * ros_message = static_cast<const _GetPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_phy_interface__srv__GetPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_phy_interface
size_t max_serialized_size_phy_interface__srv__GetPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = phy_interface__srv__GetPose_Response;
    is_plain =
      (
...
static size_t _GetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_phy_interface__srv__GetPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose_Response)() {
...
// already included above
// #include "phy_interface/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "phy_interface/srv/get_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, phy_interface, srv, GetPose)() {
