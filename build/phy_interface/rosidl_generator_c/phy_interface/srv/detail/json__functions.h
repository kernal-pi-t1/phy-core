...
#ifndef PHY_INTERFACE__SRV__DETAIL__JSON__FUNCTIONS_H_
#define PHY_INTERFACE__SRV__DETAIL__JSON__FUNCTIONS_H_
...
/// Create srv/Json message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * phy_interface__srv__Json_Request__init().
...
/// Destroy srv/Json message.
/**
 * It calls
 * phy_interface__srv__Json_Request__fini()
...
/// Check for srv/Json message equality.
/**
...
/// Initialize array of srv/Json messages.
/**
...
/// Finalize array of srv/Json messages.
/**
 * It calls
 * phy_interface__srv__Json_Request__fini()
...
/// Create array of srv/Json messages.
/**
 * It allocates the memory for the array and calls
 * phy_interface__srv__Json_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Json messages.
/**
 * It calls
 * phy_interface__srv__Json_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Json message array equality.
/**
...
/// Copy an array of srv/Json messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * phy_interface__srv__Json_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It calls
 * phy_interface__srv__Json_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It allocates the memory for the array and calls
 * phy_interface__srv__Json_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_phy_interface
...
/**
 * It calls
 * phy_interface__srv__Json_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PHY_INTERFACE__SRV__DETAIL__JSON__FUNCTIONS_H_
